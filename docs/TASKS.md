...
- Public repo cleanup committed and pushed on 2026-06-22 as `cee9bdb`: MIT LICENSE added, internal files untracked, .gitignore updated.
- Local `node tests/run-tests.js` passed on 2026-06-22 after cleanup: 0 failures.
- Local manifest parse check passed on 2026-06-22 after cleanup.
